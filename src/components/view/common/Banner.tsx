      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-6 py-8 md:py-16 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Subtitle */}
            <p className="text-md md:text-xl text-foreground/70 md:mb-8 mb-6 max-w-2xl mx-auto">
              {t('hero.subtitle')}
            </p>

            {/* CTA Button */}
            <div className="flex flex-col items-center gap-4 md:mb-8">
              <Button
                size="lg"
            ...
            {/* Feature Highlights */}
            <div className="flex flex-wrap justify-center gap-2 md:gap-6 md:mt-12 mt-6 mb-4">
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            <div
              ref={sliderRef}
              className="flex gap-4 md:gap-6 overflow-x-auto hide-scrollbars snap-x snap-mandatory scroll-smooth pb-4"
              style={{
                scrollbarWidth: 'none',
              ...
              {features.map((feature) => {
                ...
                return (
                  <div
                    key={feature.key}
                    className={cn(
                      'flex-shrink-0 w-[calc(100vw-2rem)] md:w-full snap-center',
                  ...
                  >
                    ...
                    <div className="bg-muted/30 h-[500px] md:h-[600px] flex">
                      {/* Left Sidebar - Tools */}
                      <div className="hidden md:flex w-12 lg:w-16 bg-background border-r border-border/50 flex-col items-center py-3 md:py-4 gap-2 md:gap-3">
                        <button className="w-8 h-8 md:w-10 md:h-10 rounded-lg hover:bg-muted flex items-center justify-center">
                          <Icons.menu className="w-4 h-4 md:w-5 md:h-5 text-foreground/60" />
                        </button>
                        <button className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-primary/20 flex items-center justify-center">
                          <Icons.video className="w-4 h-4 md:w-5 md:h-5 text-primary" />
                        </button>
                        <button className="w-8 h-8 md:w-10 md:h-10 rounded-lg hover:bg-muted flex items-center justify-center">
                          <Icons.mic className="w-4 h-4 md:w-5 md:h-5 text-foreground/60" />
                        </button>
                        <button className="w-8 h-8 md:w-10 md:h-10 rounded-lg hover:bg-muted flex items-center justify-center">
                          <Icons.edit className="w-4 h-4 md:w-5 md:h-5 text-foreground/60" />
                        </button>
                        <button className="w-8 h-8 md:w-10 md:h-10 rounded-lg hover:bg-muted flex items-center justify-center">
                          <Icons.play className="w-4 h-4 md:w-5 md:h-5 text-foreground/60" />
                        </button>
                      </div>
                      ...
                      <div className="flex-1 flex flex-col">
                        {/* Top Bar */}
                        <div className="h-12 md:h-14 bg-background border-b border-border/50 flex items-center justify-between px-3 md:px-6">
                          <div className="flex items-center gap-2 md:gap-4">
                            <button className="flex items-center gap-1 md:gap-2 text-xs md:text-sm text-foreground/60 hover:text-foreground">
                              <Icons.chevronLeft className="w-3 h-3 md:w-4 md:h-4" />
                          ...
                          <div className="flex items-center gap-2 md:gap-3">
                            <button className="hidden md:block px-3 md:px-4 py-1 md:py-1.5 rounded-md text-xs md:text-sm font-medium bg-muted hover:bg-muted/80">
                              Share
                            </button>
                            <button className="px-3 md:px-4 py-1 md:py-1.5 rounded-md text-xs md:text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90">
                              Done
                            </button>
                          </div>
                        </div>
                        ...
                        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0">
                          {/* Left Panel - Editor */}
                          <div className="bg-background p-3 md:p-6 border-b md:border-b-0 md:border-r border-border/50 overflow-y-auto">
                            <div className="space-y-3 md:space-y-4">
                              {/* Style Controls */}
                              <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
                                <button className="px-3 md:px-4 py-1.5 md:py-2 rounded-md bg-muted hover:bg-muted/80 text-xs md:text-sm font-medium flex items-center gap-1 md:gap-2">
                                  <Icons.edit className="w-3 h-3 md:w-4 md:h-4" />
                                  <span className="hidden md:inline">
                                    Style
                                  </span>
                                </button>
                                <button className="w-7 h-7 md:w-8 md:h-8 rounded-md border border-border/50 hover:bg-muted flex items-center justify-center">
                                  <span className="text-xs md:text-sm font-bold italic">
                                    I
                                  </span>
                                </button>
                              </div>
                              ...
                              {/* Categories */}
                              <div className="flex gap-1.5 md:gap-2 mb-3 md:mb-4 overflow-x-auto hide-scrollbars">
                                <button className="px-2.5 md:px-3 py-1 md:py-1.5 rounded-full text-xs font-medium bg-primary text-primary-foreground whitespace-nowrap">
                                  All
                                </button>
                                <button className="px-2.5 md:px-3 py-1 md:py-1.5 rounded-full text-xs font-medium bg-muted hover:bg-muted/80 whitespace-nowrap">
                                  Business
                                </button>
                                <button className="px-2.5 md:px-3 py-1 md:py-1.5 rounded-full text-xs font-medium bg-muted hover:bg-muted/80 whitespace-nowrap">
                                  Social
                                ...
                                {[1, 2, 3, 4].map((item) => (
                                  ...
                                  >
                                    <div className="flex items-center justify-between mb-0.5 md:mb-1">
                                      <span
                                        className={cn(
                                          'text-[10px] md:text-xs font-medium truncate flex-1',
                                          item === 1 && isSelected
                                            ? 'text-primary'
                                            : 'text-foreground/60'
                                        )}
                                      ...
                                      {item === 1 && (
                                        <button className="text-[10px] md:text-xs text-primary hover:text-primary/80 ml-2 flex-shrink-0">
                                          Edit
                                        </button>
                                      )}
                                    </div>
                          ...
                          <div className="bg-muted/20 p-3 md:p-6 flex flex-col">
                            <div className="flex-1 rounded-lg overflow-hidden bg-gradient-to-br from-muted to-muted/50 border border-border/50 relative min-h-[200px] md:min-h-0">
                              {/* Fake Video Preview */}
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-center space-y-2 md:space-y-4">
                                  <div className="w-20 h-20 md:w-32 md:h-32 mx-auto rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center">
                                    <Icons.video className="w-10 h-10 md:w-16 md:h-16 text-primary/40" />
                                  </div>
                                  <div className="space-y-1 md:space-y-2">
                                    <div className="text-base md:text-2xl font-bold text-foreground/80">
                                      {t(feature.titleKey)}
                                    </div>
                              ...
                              {isSelected && (
                                <div className="absolute bottom-4 md:bottom-8 left-1/2 -translate-x-1/2">
                                  <div className="px-3 md:px-6 py-2 md:py-3 bg-black/80 backdrop-blur-sm rounded-lg">
                            ...
                            <div className="mt-3 md:mt-4 space-y-1.5 md:space-y-2">
                              ...
                              <div className="flex items-center justify-between text-[10px] md:text-xs text-foreground/60">
                                <span>00:00</span>
                                <div className="flex items-center gap-1.5 md:gap-2">
                                  <button className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-muted hover:bg-muted/80 flex items-center justify-center">
                                    <Icons.chevronLeft className="w-2.5 h-2.5 md:w-3 md:h-3" />
                                  </button>
                                  <button className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-primary/20 hover:bg-primary/30 flex items-center justify-center">
                                    <Icons.play className="w-3 h-3 md:w-4 md:h-4 text-primary" />
                                  </button>
                                  <button className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-muted hover:bg-muted/80 flex items-center justify-center">
                                    <Icons.chevronRight className="w-2.5 h-2.5 md:w-3 md:h-3" />
                                  </button>
                                </div>
                                <span>00:10</span>
                              </div>
