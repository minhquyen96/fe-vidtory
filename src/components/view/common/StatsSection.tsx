        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center bg-background rounded-2xl p-6 md:p-8 border border-border/50 shadow-lg hover:shadow-xl transition-shadow"
              >
                <div className="text-5xl md:text-6xl font-bold text-primary mb-2 md:mb-3">
                  {stat.value}
                </div>
