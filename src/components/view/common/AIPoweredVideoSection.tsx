...
export function AIPoweredVideoSection({ className }: AIPoweredVideoSectionProps) {
  ...
  return (
    <section className={cn('relative overflow-hidden bg-muted/20 py-8 sm+:py-16', className)}>
      ...
      {/* Gradient orbs */}
      <div className="absolute left-1/4 top-20 w-80 h-80 bg-primary/15 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob z-0" />
      <div className="absolute right-1/4 bottom-20 w-80 h-80 bg-secondary/15 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-3000 z-0" />
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-primary/12 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-blob animation-delay-1500 z-0" />
