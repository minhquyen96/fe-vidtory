...
export interface AdInputs extends BaseInputState {
  adMode: 'manual' | 'auto'; // New toggle
  url: string; // For auto mode
  brandName: string;
  headline: string;
...
export const STYLE_PRESETS = {
  en: {
    ...
    [AppMode.ADVERTISING]: ['Minimalist', 'Luxury', 'Pop Art', 'Corporate', 'Cyberpunk', 'Product Photography', 'Editorial'],
  ...
  vi: {
    ...
    [AppMode.ADVERTISING]: ['Tối Giản', 'Sang Trọng', 'Pop Art', 'Doanh Nghiệp', 'Cyberpunk', 'Chụp Ảnh Sản Phẩm', 'Tạp Chí'],
...
export const TASK_ACTIONS = {
  en: [
    { id: 'story', label: 'New Story', prompt: 'Visualize a new story based on the description.' },
    { id: 'continue', label: 'Continue Next Page', prompt: 'The reference images are the previous pages. Draw the IMMEDIATE NEXT PAGE in the sequence.' },
    { id: 'mix', label: 'Mix Characters', prompt: 'Blend the visual elements and characters from the reference images into a new visual scenario.' },
...
export const STORY_IDEAS = {
  en: [
    ...
    { short: "Cat President", full: "A serious press conference where the newly elected President is a fluffy orange cat. Reporters are holding out microphones, and the cat is knocking a glass of water off the podium." },
    { short: "Zombie Barista", full: "A tired zombie barista trying to make intricate latte art for a hipster vampire customer in a spooky coffee shop. The zombie's arm is falling off." },
    { short: "Alien Tourist", full: "An alien tourist wearing a Hawaiian shirt and holding a camera, looking confused at a cow in a field, thinking it's the dominant species." },
  ...
  vi: [
    ...
    { short: "Mèo Tổng Thống", full: "Một cuộc họp báo nghiêm túc nơi Tổng thống mới đắc cử là một chú mèo mướp màu cam. Các phóng viên đang đưa micro, còn chú mèo thì đang gạt ly nước rơi khỏi bục phát biểu." },
    { short: "Zombie Pha Chế", full: "Một zombie mệt mỏi đang cố gắng vẽ hình nghệ thuật trên ly latte cho một khách hàng ma cà rồng sành điệu. Tay của zombie sắp rụng ra." },
    { short: "Khách Du Lịch Alien", full: "Một người ngoài hành tinh mặc áo sơ mi Hawaii cầm máy ảnh, nhìn chằm chằm vào một con bò trên đồng cỏ với vẻ bối rối, tưởng đó là loài thống trị trái đất." },
...
export const TRANSLATIONS = {
  en: {
    ...
    sidebar: {
      [AppMode.COMIC]: "Create Comic",
      [AppMode.ADVERTISING]: "Ads Design",
      [AppMode.INFOGRAPHIC]: "Infographic"
    },
    labels: {
      story: "Story Idea",
      refImages: "Reference Images",
      assets: "Product / Logo / Assets",
      ...
      readyDesc: "Configure your settings on the left panel and hit generate to see magic.",
      noHistory: "No history for this session yet.",
      autoMode: "Auto (URL)",
      manualMode: "Manual",
    ...
    tooltips: {
      story: "Describe the plot, characters, and setting for your comic page. Be descriptive!",
      refImages: "Upload images to control character look or color palette.",
      assets: "Upload product shots, logos, or model photos. AI will composite them into the ad.",
      task: "Choose how the AI should use your reference images (e.g., continue story, mix style).",
      mangaRef: "Select a famous manga style to strongly influence the drawing technique.",
      ...
      target: "Who is this ad for? (e.g., Gamers, Professionals) - Helps AI choose the right tone.",
      ...
      url: "Enter a product or landing page URL. AI will analyze the brand and create an ad automatically."
    },
    placeholders: {
    ...
    errors: {
      noCredits: "Out of credits! Please upgrade.",
      unknown: "An unexpected error occurred.",
      missingStory: "Please input Story Idea...",
      missingBrand: "Please input Brand Name...",
      missingTopic: "Please input Main Topic...",
      missingUrl: "Please input Target URL...",
  ...
  vi: {
    ...
    labels: {
      ...
      readyTitle: "Sẵn sàng sáng tạo?",
      readyDesc: "Cấu hình cài đặt ở bảng bên trái và nhấn tạo để thấy điều kỳ diệu.",
      noHistory: "Chưa có lịch sử cho phiên này.",
      autoMode: "Tự Động (Link)",
      manualMode: "Thủ Công",
      targetUrl: "Link Sản Phẩm",
      analyzing: "Đang phân tích Link..."
    },
    tooltips: {
      story: "Mô tả cốt truyện, nhân vật và bối cảnh cho trang truyện của bạn.",
      refImages: "Tải lên hình ảnh để AI tham khảo thiết kế nhân vật hoặc bảng màu.",
      assets: "Tải lên ảnh sản phẩm, logo hoặc người mẫu. AI sẽ lồng ghép chúng vào thiết kế.",
      ...
      target: "Quảng cáo này dành cho ai? (vd: Game thủ, Dân văn phòng) - Giúp AI chọn giọng điệu phù hợp.",
      ...
      url: "Nhập link sản phẩm hoặc trang web. AI sẽ tự động phân tích thương hiệu và tạo quảng cáo."
    },
    placeholders: {
    ...
    errors: {
      noCredits: "Hết credit! Vui lòng nâng cấp.",
      unknown: "Đã xảy ra lỗi không mong muốn.",
      missingStory: "Vui lòng nhập Ý Tưởng Cốt Truyện...",
      missingBrand: "Vui lòng nhập Tên Thương Hiệu...",
      missingTopic: "Vui lòng nhập Chủ Đề Chính...",
      missingUrl: "Vui lòng nhập Link Sản Phẩm...",
